    ...
    <div className="container11">
      <div class="card1">
                <div class="item-dept itemd1">
                    <div class="content">
                        <img className="mt-4" src="https://img.freepik.com/free-vector/app-development-banner_33099-1720.jpg?size=626&ext=jpg" alt="unicorn" />
                        <h3>design</h3>
                    </div>
                </div>
                <div class="item-dept itemd2">
                    ...
                    <a href="#">Our Projects/Resources</a>
                </div>
            </div>
    </div>
  );
